...
svg {
    width: 100%;
    height: 100%;
    background-image: url("../includes/images/day2.png");
	...
	<nav aria-label="...">
	  <ul class="pager">
	    <li class="previous disabled"><a href="#"><span class="glyphicon glyphicon-arrow-left" aria-hidden="true"></span></a></li>
	    	<h3 style="text-align:center;display:inline-block;">Wednesday<br><small>September 21, 2016</small></h3>
...
if ( !empty($attributes) || !empty($searchterm) ){
  ...
  if (mysqli_connect_errno()) {
	...
	$query = "	SELECT unit_x,unit_y 
			...
			WHERE day_company_booth.day_id = 2
		";
